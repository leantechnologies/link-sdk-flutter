    ...
    group('pay', () {
      test('throws an error when required params are missing', () {
        expect(
            ...
            throwsA(predicate((e) =>
                e is FormatException &&
                e.message == 'Validation Error: paymentIntentId or bulkPaymentIntentId is required')));
      });

      test('throws an error when required params are missing', () {
        expect(
            () => leanSdk.pay(bulkPaymentIntentId: ""),
            throwsA(predicate((e) =>
                e is FormatException &&
                e.message == 'Validation Error: paymentIntentId or bulkPaymentIntentId is required')));
      });
      ...
      test('partial params: returns the correct URL', () {
        const expectedUrl =
            'https://cdn.leantech.me/link/loader/prod/ae/latest/lean-sdk.html?implementation=webview-hosted-html&implementation_config=platform+mobile&implementation_config=sdk+flutter&implementation_config=os+macos&implementation_config=sdk_version+3.0.2&implementation_config=is_version_pinned+false&app_token=9fb9e934-9efb-4e7e-a508-de67c0839be0&sandbox=false&language=en&version=latest&country=ae&env=production&method=pay&payment_intent_id=617207b3-a4d4-4413-ba1b-b8d32efd58a0&payment_intent_id=617207b3-a4d4-4413-ba1b-b8d32efd58a0';
      ...
      test('all params: returns the correct URL', () {
        const expectedUrl =
            'https://cdn.leantech.me/link/loader/prod/ae/latest/lean-sdk.html?implementation=webview-hosted-html&implementation_config=platform+mobile&implementation_config=sdk+flutter&implementation_config=os+macos&implementation_config=sdk_version+3.0.2&implementation_config=is_version_pinned+false&app_token=9fb9e934-9efb-4e7e-a508-de67c0839be0&sandbox=false&language=en&version=latest&country=ae&env=production&method=pay&payment_intent_id=617207b3-a4d4-4413-ba1b-b8d32efd58a0&payment_intent_id=617207b3-a4d4-4413-ba1b-b8d32efd58a0&account_id=617207b3-a4d4-4413-ba1b-b8d32efd58a0&show_balances=true&fail_redirect_url=https://dev.leantech.me/fail&success_redirect_url=https://dev.leantech.me/success';
